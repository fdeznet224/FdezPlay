...
class TvSeriesPlayerScreen extends StatefulWidget {
  const TvSeriesPlayerScreen({
  ...
  @override
  State<TvSeriesPlayerScreen> createState() {
    return _TvSeriesPlayerScreenState();
  }
}

class _TvSeriesPlayerScreenState
    extends State<TvSeriesPlayerScreen>
  ...
  String get _episodeUrl => _buildEpisodeUrl(_activeSource.episode);
  ...
  Future<bool> _switchToNextSource() async {
    if (_isClosing || _switchingSource) {
      return false;
    }
  ...
  Future<void> _handleBackground() async {
    ...
    _playbackExpected = false;
    _resumePlaybackOnForeground = _controller.value.isPlaying;
    _sourceStartupTimer?.cancel();
