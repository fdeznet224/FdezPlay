...
class TvMoviePlayerScreen extends StatefulWidget {
  const TvMoviePlayerScreen({
  ...
  @override
  State<TvMoviePlayerScreen> createState() {
    return _TvMoviePlayerScreenState();
  }
}

class _TvMoviePlayerScreenState
    extends State<TvMoviePlayerScreen>
  ...
  String get _movieUrl => _buildMovieUrl(_activeMovie);
