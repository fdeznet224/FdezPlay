...
class TabletSeriesScreen extends StatefulWidget {
  const TabletSeriesScreen({
  ...
  @override
  State<TabletSeriesScreen> createState() => _TabletSeriesScreenState();
}

class _TabletSeriesScreenState extends State<TabletSeriesScreen> {
  ...
  Future<void> _refreshVisibleContent() async {
    ...
    try {
      ...
      if (selected != null) {
        unawaited(_loadSelectedDetails(selected));
      }
    } catch (_) {
      if (!mounted || requestId != _seriesRequestId) {
        return;
  ...
  Widget build(BuildContext context) {
    if (_loadingInitialData) {
      return const _TabletSeriesInitialLoading();
    }

    if (_errorMessage != null && _categories.isEmpty) {
      return _TabletSeriesFullError(
              ...
              builder: (context, constraints) {
                ...
                return Row(
                  ...
                  children: [
                    SizedBox(
                      width: categoryWidth,
                      child: _TabletSeriesCategoryPanel(
                    ...
                    SizedBox(
                      width: catalogWidth,
                      child: _TabletSeriesCatalogPanel(
                    ...
                    SizedBox(width: gap),
                    Expanded(
                      child: _TabletSeriesDetailsPanel(
                        group: selectedGroup,
...
class _TabletSeriesHeader extends StatelessWidget {
  const _TabletSeriesHeader({
...
class _TabletSeriesSearchField extends StatelessWidget {
  const _TabletSeriesSearchField({
...
class _TabletSeriesCategoryPanel extends StatelessWidget {
  const _TabletSeriesCategoryPanel({
...
class _TabletSeriesCatalogPanel extends StatelessWidget {
  const _TabletSeriesCatalogPanel({
  ...
  Widget _buildContent() {
    if (_loading && groups.isEmpty) {
      return const _TabletSeriesPanelLoading(
        message: 'Cargando series...',
      );
    }

    if (errorMessage != null && groups.isEmpty) {
      return _TabletSeriesPanelError(
    ...
    if (groups.isEmpty) {
      return _TabletSeriesPanelEmpty(
...
class _TabletSeriesCard extends StatelessWidget {
  const _TabletSeriesCard({
    required this.group,
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: AppCachedImage(
                        ...
                        cacheWidth: 300,
                        cacheHeight: 450,
                        placeholder: const _TabletSeriesPosterFallback(
                          loading: true,
                        ),
                        fallback: const _TabletSeriesPosterFallback(),
                      ),
                    ),
                    if (favorite)
                      const Positioned(
...
class _TabletSeriesDetailsPanel extends StatelessWidget {
  const _TabletSeriesDetailsPanel({
    required this.group,
  ...
  Widget build(BuildContext context) {
    ...
    if (selectedGroup == null) {
      return const _TabletSeriesPanel(
        child: _TabletSeriesPanelEmpty(
            ...
            child: Stack(
              ...
              children: [
                AppCachedImage(
                  ...
                  cacheWidth: 900,
                  cacheHeight: 500,
                  placeholder: const _TabletSeriesBackdropFallback(
                    loading: true,
                  ),
                  fallback: const _TabletSeriesBackdropFallback(),
                ),
                const DecoratedBox(
                  decoration: BoxDecoration(
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _TabletSeriesEpisodeCard(
                    episode: episode,
...
class _TabletSeriesEpisodeCard extends StatelessWidget {
  const _TabletSeriesEpisodeCard({
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: AppCachedImage(
                        ...
                        cacheWidth: 260,
                        cacheHeight: 150,
                        placeholder: const _TabletEpisodeFallback(
                          loading: true,
                        ),
                        fallback: const _TabletEpisodeFallback(),
                      ),
                    ),
                    Center(
                      child: Container(
...
class _TabletEpisodeMeta extends StatelessWidget {
  const _TabletEpisodeMeta({
    required this.icon,
    required this.text,
...
class _TabletSeriesInfoChip extends StatelessWidget {
  const _TabletSeriesInfoChip({
    required this.icon,
    required this.label,
...
class _TabletSeriesDetailLine extends StatelessWidget {
  const _TabletSeriesDetailLine({
    required this.label,
    required this.value,
  });
...
class _TabletSeriesPanel extends StatelessWidget {
  const _TabletSeriesPanel({required this.child});
...
class _TabletSeriesBadge extends StatelessWidget {
  const _TabletSeriesBadge({
    required this.icon,
    required this.color,
    this.text,
  });
...
class _TabletSeriesPosterFallback extends StatelessWidget {
  const _TabletSeriesPosterFallback({this.loading = false});
...
class _TabletSeriesBackdropFallback extends StatelessWidget {
  const _TabletSeriesBackdropFallback({this.loading = false});
...
class _TabletEpisodeFallback extends StatelessWidget {
  const _TabletEpisodeFallback({this.loading = false});
...
class _TabletSeriesPanelLoading extends StatelessWidget {
  const _TabletSeriesPanelLoading({required this.message});
...
class _TabletSeriesPanelError extends StatelessWidget {
  const _TabletSeriesPanelError({
...
class _TabletSeriesPanelEmpty extends StatelessWidget {
  const _TabletSeriesPanelEmpty({
    required this.icon,
    required this.title,
    required this.message,
  });
...
class _TabletSeriesInitialLoading extends StatelessWidget {
  const _TabletSeriesInitialLoading();
...
class _TabletSeriesFullError extends StatelessWidget {
  const _TabletSeriesFullError({
    required this.message,
    required this.onRetry,
  });
